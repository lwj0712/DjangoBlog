...
- [ERD](#ERD)
- [URL 구조](#URL 구조)
- [와이어 프레임 및 화면 설계 초안](#와이어-프레임-및-화면-설계-초안)
- [화면 설계 및 구현 화면](#화면-설계-및-구현-화면)
- [시연 영상](#시연-영상)
- [후기](#후기)
...
Django CBV를 사용한 블로그 프로젝트를 완료하면서, 계획했던 것보다 훨씬 시간을 많이 소요했고 어려웠지만 많은 것을 배웠습니다. CBV의 개념이 어렵게 느껴졌지만, 구현해 나가면서 그 강력함과 유연성을 깨달았습니다.
